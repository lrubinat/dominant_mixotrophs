...
```{r read_SAGs_classification, echo=F, message=F, results="hide"}
...
#reorder columns
SAGs_lt<-SAGs_lt[,c(10,2,3,4,5,6,7,8,11)]
SAGs_lt[1:5,]


datatable(head(SAGs_lt_reordered, 872), 
          colnames = c('ident.%' = 3, 'SAG_lth' = 4, 'swm_lth' = 5, 'abund' = 7),
          ...
          options = list(
            ...
            order = (list(list(6, 'desc'), list(7, 'desc'), list(2, 'desc'))),
